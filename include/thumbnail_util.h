 ...
 *
 * @post Results of all requests except for canceled request is provided to thumbnail_extracted_cb callback.
 */
 ...
 *
 * @pre Create a thumbnail info handle by calling thumbnail_util_create().
 * @see Set the size of the thumbnail by calling thumbnail_util_size().
